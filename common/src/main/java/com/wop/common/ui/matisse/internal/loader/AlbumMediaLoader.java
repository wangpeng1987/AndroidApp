 ...
 */
package com.wop.common.ui.matisse.internal.loader;
...
public class AlbumMediaLoader extends CursorLoader {
    ...
    private static final String SELECTION_ALL =
            "(" + MediaStore.Files.FileColumns.MEDIA_TYPE + "=?"
                    ...
                    + " AND LIKE('%BOOchat/chatdown%'," + MediaStore.MediaColumns.DATA +") = 0"
                    + " AND LIKE('%BOOchat/SendMsg%'," + MediaStore.MediaColumns.DATA +") = 0";
