 ...
 * 共用对话框，只有一个button的情况
 */
public class DialogCommonSingleFragment extends BaseDialogFragment {
    ...
    @BindView(R2.id.dialog_single_actv)
    AppCompatTextView dialogSingleActv;
    ...
    public View inflaterView(LayoutInflater inflater, ViewGroup container) {
        View view = inflater.inflate(R.layout.fragment_dialog_common_single, container, false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        dialogSingleActv.setText(bundle.getString(KEY_BTN_TEXT));
    ...
    //设置对话框消失监听事件
    public DialogCommonSingleFragment setDismissListener(OnDismissListener listener) {
        this.mListener = listener;
        return this;
    }

    //点击back建是否允许取消
    public DialogCommonSingleFragment setCance(boolean value) {
        setCancelable(value);
        return this;
    }

    @OnClick(R2.id.dialog_single_actv)
    ...
    public static final class Builder {
        ...
        public DialogCommonSingleFragment build() {
            DialogCommonSingleFragment fragment = new DialogCommonSingleFragment();
