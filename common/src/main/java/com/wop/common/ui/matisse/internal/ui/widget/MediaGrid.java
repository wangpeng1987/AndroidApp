...
public class MediaGrid extends SquareFrameLayout implements View.OnClickListener {
    ...
    private RelativeLayout videoDurationRl;
    ...
    private void init(Context context) {
        LayoutInflater.from(context).inflate(R.layout.include_album_grid_item, this, true);

        mThumbnail = (ImageView) findViewById(R.id.media_thumbnail);
        mCheckView = (CheckView) findViewById(R.id.check_view);
        mGifTag = (ImageView) findViewById(R.id.gif);
        mVideoDuration = (TextView) findViewById(R.id.video_duration);
        videoDurationRl = findViewById(R.id.video_duration_rl);
    ...
    private void setVideoDuration() {
        if (mMedia.isVideo()) {
            videoDurationRl.setVisibility(VISIBLE);
            mVideoDuration.setText(DateUtils.formatElapsedTime(mMedia.duration / 1000));
        } else {
            videoDurationRl.setVisibility(GONE);
        }
    }
